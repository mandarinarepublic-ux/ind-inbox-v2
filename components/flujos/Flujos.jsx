...
import {
  getFlujos, saveFlujo, publicarFlujo, deleteFlujo, getPasosFlujo,
  fetchRepliesFromSheet, getAnuncios,
} from '@/lib/api-client'
...
const DATOS_NUEVOS = {
  mensaje: () => ({ origen: 'texto', texto: '', adjuntos: [], botones: [], esperarRespuesta: false, citarUltimaRespuesta: false, etapa: '' }),
