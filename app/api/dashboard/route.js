...
// Dashboard COMBINADO (Mandarina + IND + total) con filtro ?meses=3|6|12.
export const dynamic = 'force-dynamic'

const MANDI_SHEET = process.env.MANDI_SHEET_ID || '1ZQ_vIhKsDBnAUjitOB3zP-4MDbdmsv7hdDgnqNbOkak'
const IND_SHEET   = process.env.SHEET_ID || '1ObNIff1ypeFW7PfuAjeoiGBJCDyZU4etIsbGpyB-Nqk'
const TIENDAS = [
...
function computeTienda(contRows, msgRows, pedidos, tiendaId, monthKeys) {
  ...
  return {
    totalContactos, estados, salientesPorMes, leadsPorMes, ventasNPorMes,
