...
// acá, aunque ahora SÍ viaja en cada poll de getMensajesSupabase (COLS_MSG, no
// select('*')). getListaSupabase NO puede sumarlo: sale de una VISTA
// (ultimos_mensajes_canal) que no lo expone, y cambiar esa vista es tocar la
// base — la lista lateral se queda con la etiqueta genérica para las filas
// viejas (toMensaje ya sabe hacerlo sin `raw`).
