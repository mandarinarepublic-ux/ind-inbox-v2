...
// Columnas que necesita la UI. NUNCA usar select('*') aquí: arrastraría `raw`
// (el payload crudo del webhook, jsonb pesado) en cada poll.
...
// Descarta mensajes 'system' y los que no tienen NADA que pintar (ni texto, ni
// media, ni botones) → evita chats fantasma. Mismo criterio que la hoja.
const pintable = (m) =>
