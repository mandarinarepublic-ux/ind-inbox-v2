...
//
// `tipo` (pago_ok / pago_error / null) se sumó el 15-ago-2026 al portar LINK
// PAGO desde MANDI: la columna `tipo` de `inbox.notas` ya existía (tabla
// compartida entre los dos inbox, separada por `cuenta`), así que esto NO
