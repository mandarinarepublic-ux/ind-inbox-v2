// lib/ia-canal.js — ¿Puede el bot de WhatsApp de IND responder este mensaje?
//
// Dos rejas en serie, y el orden importa:
//   1. CORTAFUEGOS por número (config.ia.principal / .secundario) — apaga el bot
//      entero en ese canal, sin tocar el estado de ningún chat.
...
// no borra.
//
// Este módulo NO conoce el interruptor maestro `IA_AUTORESPUESTA` (variable de
// entorno que apaga el bot completo, en los dos canales a la vez). Ese combinado
// se hace en el webhook, no acá: aquí solo se decide canal + chat.
//
...
/**
 * ¿Está el bot habilitado en el número por el que entró este mensaje?
