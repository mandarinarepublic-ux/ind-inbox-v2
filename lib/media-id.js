...
// El phone id vive en lib/meta-ids.js, que es la ÚNICA fuente. Se re-exporta acá
// porque varios módulos ya lo importaban desde este archivo.
export { META_PHONE_ID } from './meta-ids.js'
  ...
  for (let i = 0; i < intentos; i++) {
    try {
      ...
      const res = await fetch(url, {
        headers: { 'User-Agent': 'Mozilla/5.0 (compatible; IndInbox/1.0)', Accept: 'image/*' },
        signal: ctrl.signal,
