...
// dónde está parado.
import { avanzarDesde, evaluarCondicion, paradaDeCamino, citaDeTanda, piezasDeNodos, etapaAlPasar } from './flujo.js'
...
export async function correrTanda(deps, { flujo, desde, esDisparo, contacto, wamidEntrante = '', ultimoWamid = '', respuestas = [] }) {
  const { enviar, guardarEstado, borrarEstado, registrarPasos, setEtapa, avisar, ahora, cuenta = '', log = console.log } = deps
