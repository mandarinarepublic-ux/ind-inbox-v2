 ...
 */
export async function enviarAudioUrl(telefono, nombre, audioUrl) {
  return postSaliente({ Telefono: telefono, Nombre: nombre, AudioURL: audioUrl })
}
...
export async function enviarDocumentoUrl(telefono, nombre, docUrl, nombreArchivo = '') {
  return postSaliente({
