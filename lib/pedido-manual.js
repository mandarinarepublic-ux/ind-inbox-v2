 ...
 * (`crm.apps.mandarinaec.com` → `ind-inbox.apps.mandarinaec.com`), y `window`
 ...
 * por carácter a la plantilla cruda que usaba el camino con IA. Ese botón ya no
 * existe, pero sus notas siguen en la base y conviven con las nuevas en el mismo
 * chat. Hay una prueba que lo vigila: no cambies el formato a la ligera.
 */
