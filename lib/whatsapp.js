...
const META_PHONE_ID = process.env.META_PHONE_ID || '1135333936337730' // IND STORE
// WABA de IND conocida ("IND STORE" 1003593902536446). Vive en otro Business Manager
// que el token controla directamente, así que la fijamos como default (override por env).
const ENV_WABA      = process.env.META_WABA_ID || '1003593902536446'
