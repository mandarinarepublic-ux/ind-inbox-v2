...
//
// El número de IND está en coexistencia: vive a la vez en Cloud API y en la
// app de WhatsApp Business del teléfono. Cuando se contesta desde el celular,
// Meta nos avisa por el campo `message_echoes`, y ese mensaje NO existía para
...
//   - `from` viene como número visible (593984159804), NO como phone_id, así que
...
/** Payload de un evento `message_echoes` → filas listas para guardar. */
