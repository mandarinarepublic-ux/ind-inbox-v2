 ...
 * nombre — `debeNotificar`), y ese era el bug: un cliente que escribía una vez y
 * esperaba generaba un solo aviso en toda su vida (12 chats pendientes, el más
 * viejo 31 horas esperando, todos con su único push ya gastado). El aviso ahora
 * se manda SIEMPRE; esta función solo apaga el sonido.
 */
