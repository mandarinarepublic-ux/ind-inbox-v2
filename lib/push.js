// lib/push.js — Web push de avisos de mensajes nuevos (línea IND).
//
...
//
// IND tiene su PROPIO par de claves, distinto al de MANDI, y las suscripciones se
// separan por la columna `cuenta` de inbox.push_subs (tabla compartida).
...
/** Un aviso por conversación cada 5 minutos. Contestar lo reinicia. */
 ...
 * un lead.
 *
 * OJO: contestar pone ultimo_push_at en NULL (lo hace limpiarPush desde
 * /api/saliente), así que un mensaje que llega DESPUÉS de tu respuesta siempre
 * avisa. Sin eso solo llegaba el aviso del primer mensaje de cada persona.
 */
...
/**
 * Manda el aviso a todos los aparatos suscritos de ESTA cuenta. NUNCA lanza.
