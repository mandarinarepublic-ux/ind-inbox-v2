...
//
// ⚠️ TERCERA VEZ que el filtro de "¿hay algo que pintar?" (lib/inbox-supabase.js)
// se come mensajes de verdad (antes: fotos sin caption, notas de voz). Acá la
// regla que vale para SIEMPRE: "sin texto" NO significa "no pasó nada". Si Meta
// manda un tipo con contenido real (order) o un tipo donde igual escribió una
// persona (unsupported, system), este extractor le arma un `contenido` no vacío
// A PROPÓSITO — así el filtro lo deja pasar solo, sin tener que conocer estos
// tipos especiales.
