...
//
// Por qué existe: el 7-ago-2026, al encender el candado EN MANDI, tres mensajes
// salientes murieron con 401 y la pantalla solo dijo "no se pudo enviar". Quien
// atendía lo vivió como "se perdieron 3 chats" en vez de "tengo que volver a
// entrar", y los reenvió a mano. El candado hizo lo suyo; lo que faltó fue avisar.
// Acá el aviso entra JUNTO con el candado, no después: IND manda ~1.900 salientes
// cada 3 días hechos por personas, y un 401 mudo se multiplicaría por esa cifra.
//
// Por qué se intercepta `fetch` en vez de tocar cada llamada: hay 16 en
