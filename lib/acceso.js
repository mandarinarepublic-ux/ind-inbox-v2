...
/**
 * Permiso que exige este inbox. Acá es INBOX_INDSTORE — el de MANDI es
 * INBOX_MANDARINA, y son listas de gente DISTINTA en `crm.usuarios.accesos`.
 * Al 8-ago-2026 lo tienen Andrés Admin y Xavier Castillo, los dos activos.
 * Se deja sobreescribible por entorno para poder corregirlo sin desplegar código.
 */
export const PERMISO = process.env.INBOX_PERMISO || 'INBOX_INDSTORE'
