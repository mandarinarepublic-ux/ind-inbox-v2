...
export const config = {
  matcher: [
    '/((?!api/webhook|api/cron/seguimientos|api/cron/pendientes|api/cron/entregas|api/cron/pagos|api/cron/flujos|api/pago-dlocal|_next/static|_next/image|favicon.ico|sw.js|icon-|apple-touch-icon|manifest.webmanifest).*)',
  ],
}
