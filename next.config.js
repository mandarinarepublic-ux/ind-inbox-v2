...
const nextConfig = {
  ...
  // El commit de ESTE bundle, horneado en el navegador. El servidor manda el suyo
  // en cada /api/inbox-sync: si difieren, la pestaña corre código viejo.
  ...
  //   api/   → por /api/webhook entra Meta, apuntando al host viejo. Meta NO
  //            sigue redirecciones: un 307 acá es dejar de recibir mensajes
  //            (7.880 llamadas en 3 días).
  ...
  async redirects() {
    return [{
      ...
      has: [{ type: 'host', value: 'ind-inbox-v2.vercel.app' }],
      destination: 'https://ind-inbox.apps.mandarinaec.com/:path',
