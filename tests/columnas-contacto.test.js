...
// las 3.967 conversaciones de IND para usar 16 — la fila completa pesa 1.220 kB
// contra 476 kB de lo que se usa (61% menos), y es el 65% del payload y el rubro más caro de la factura de Vercel. Recortarlo es la mitad
...
test('no se piden columnas que nadie usa', () => {
  // El otro lado de la moneda: cada columna de más son ~3.967 filas de peso en
