...
// Antes esto esperaba la etiqueta generica "Aviso de WhatsApp" aunque Meta
// hubiera dicho que paso. Se cambio a proposito el 4-sep-2026: lo que Meta manda
// es mas util que una etiqueta fija, y estos avisos se quedan en la bandeja como
// si un cliente esperara respuesta. Lo que NO cambia es que nunca queda vacio.
...
// entera desaparecía del sidebar (medido: IND 17 reaction, 3 edit, 1 revoke,
// 1 contacts; 32 conversaciones entre los dos inbox, 13 pendientes).
...
test('extraer no guarda un texto realmente vacio en blanco (bug real de MANDI, repo hermano)', () => {
