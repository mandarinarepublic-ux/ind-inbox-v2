...
test('correrTanda: disparo lineal → manda citando el entrante, registra pasos, etapa, borra estado', async () => {
...
test('correrTanda: camino roto → no manda, borra estado; un fallo en pasos o etapa no frena el envío', async () => {
  const { deps, reg } = depsFalsas()
